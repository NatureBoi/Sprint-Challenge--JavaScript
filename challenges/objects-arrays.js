...
const tyrannosaurus = new Trex({name: 'Tyrannosaurus',diet: 'carnivorous',  weight: '7000kg',  length: '12m',  period:'Late Cretaceious',});
...
*/
  ...
  const populationTotal =
    zooAnimals.map(el => el.population);
